# Regional Review: Ocean Warming and Acidification Trends in the Bay of Bengal
...
*   **`/Data`**: Summarized datasets of water quality parameters, including sea surface temperature and pH records across different sectors.
*   **`/Scripts`**: R scripts used for:
    *   Correlation analysis among different water quality parameters.
